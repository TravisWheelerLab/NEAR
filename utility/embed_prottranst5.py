...
def read_fasta( fasta_path ):
    ...
    sequences = dict()
    seq_order = dict()
    print("Reading {}".format(fasta_path))
...
def get_embeddings( seq_path,
    ...
    # Read in fasta
    seq_dict, seq_order = read_fasta( seq_path )
    ...
    print("Embed time = " + str(start - end))
