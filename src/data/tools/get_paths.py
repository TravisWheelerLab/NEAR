...
with open("/xdisk/twheeler/daphnedemekas/train_paths2.txt", "w", encoding="utf-8") as tpaths:
...
with open("/xdisk/twheeler/daphnedemekas/valpaths2.txt", "w", encoding="utf-8") as valpaths:
